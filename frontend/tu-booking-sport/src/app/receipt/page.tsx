...
export default function ReceiptPage() {
    ...
    return (
            ...
            <section className="w-[360px] min-h-[740px] rounded-lg border bg-white shadow-sm overflow-hidden">
                ...
                <div className="px-6 pb-8">
                    ...
                    <div className="mt-8 flex flex-col items-center gap-3">
                        ...
                        <label
                            htmlFor="upload-slip"
                            className="px-6 py-2 rounded-md bg-blue-700 text-white text-[14px] cursor-pointer hover:bg-blue-800 active:scale-[.99]"
                        >
                            Upload Slip
                        </label>
                        <input
        ...
        //  สามารถต่อ fetch('/api/upload-slip', {method: 'POST', body: file }) ได้เลย
      }
    }}
  />
                    </div>
