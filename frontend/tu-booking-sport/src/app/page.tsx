  ...
  return (
    <div className="bg-gray-50 flex items-center justify-center min-h-screen">
      <div className="relative border-2 border-black rounded-[10px] px-[20px] pt-[40px] pb-[20px] w-[300px] bg-gray-50">
        <h2 className="absolute -top-[15px] left-[100px] -translate-x-1/2 bg-gray-50 px-[10px] font-bold text-2xl">
        LOG-IN
        </h2>

        <form className="space-y-5">
        <div className="relative">
          <label htmlFor="email" className="absolute -top-[10px] left-[10px] block text-sm font-medium text-gray-700 mb-1 bg-gray-50">
            E-mail / ID*</label>
            <div className="relative">
        ...
        <div className="relative">
          <label htmlFor="password" className="absolute -top-[10px] left-[10px] block text-sm font-medium text-gray-700 mb-1 bg-gray-50">Password*</label>
            <div className="relative">
